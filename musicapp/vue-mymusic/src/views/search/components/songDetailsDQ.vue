...
<template>
  <div class="song_details">
    <div class="song_details_toper clearfix">
      <div class="left">
        <i class="iconfont icon-zanting"></i><span>播放全部</span>
      </div>
      <div class="right">
        <i class="iconfont icon-MENU"></i><span>多选</span>
      </div>
    </div>
    <div class="song_details_list clearfix" v-for="(item,index) in songList" :key="index" @click="playSong">
      <div class="left">
        <div class="top">
